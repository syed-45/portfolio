export const About = (): JSX.Element => {
  return (
    <section
      id='about'
      className='min-h-3/4 from-light-green mt-10 flex flex-col justify-center gap-4 rounded-xl bg-gradient-to-tr px-7 py-20 text-neutral-700 shadow-xl drop-shadow-sm sm:px-20 '
    >
      <h2 className='mb-5 text-neutral-800'>About Me</h2>
      <p>
